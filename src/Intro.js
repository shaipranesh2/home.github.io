...
in India with campuses in Pilani, Goa, Hyderabad, and Dubai).</p>
     <div className="list-elements">
        <p>I am interested in emulating intelligence in artificial agents. As such, the fields which have captured my research interest for the duration of my undergraduate education are:</p>
        <ul>
